...
ColumnLayout {
    ...
    property int widgetContentPadding: 8
    ...
    Rectangle {
        ...
        Repeater {
            ...
            model: root.logic.widgetInstanceListToWidgetDataList(root.model, gridPanel, root.widgetRadius, root.widgetContentPadding)
            delegate: PanelTile {
                id: gridItem
