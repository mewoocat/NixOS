    ...
    */
    ...
    function generateId(): string {
        ...
        for (let m of monitors) {
            const mObj = m.lastIpcObject // Is an empty object when method is ran right after monitor event occured
            console.log(`generatingId for: ${JSON.stringify(mObj)}`)
            if (mObj === undefined) {
    ...
    function loadConfig(): void { 
        ...
        console.log(`loading monitor config: ${conf}`)
        // Set monitor config
        ...
        function onRawEvent(event) {
            ...
            switch (event.name) {
                ...
                case "monitorremovedv2":
                    ...
                    Hyprland.refreshMonitors()
                    loadConfig() // Load in a saved monitor config for the given monitors and ports
                default:
